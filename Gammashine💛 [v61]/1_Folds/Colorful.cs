...
namespace Snaplight
{
    ...
    public static class Colorful
    {
        ...
        /// <summary> Сделайте собственный цвет </summary>
        public static Color32 Custom(byte r, byte g, byte b, byte a) => new(r, g, b, a);
        /// <summary> Сделайте собственный цвет </summary>
        public static Color Custom(float r, float g, float b, float a) => new(r, g, b, a);
        /// <summary> Сделайте собственную прозрачность </summary>
