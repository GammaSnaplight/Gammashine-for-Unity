...
{
    public partial struct TimedataDouble : ITimemodel<double>
    {
        // ITimemodel
        ...
        // Serializable
        internal readonly double Percent => Timer >= Limit ? 1 : Timer / Limit;
        internal readonly double Countdown => Timer >= Limit ? 0 : Limit - Timer;
        internal readonly double CountdownPercent => Timer >= Limit ? 0 : (Limit - Timer) / Limit;
        ...
        //===
        public TimedataDouble(double limit)
        {
        ...
        public override readonly string ToString()
        {
            ...
            {
                return $"[AUTO] Controllable: {Controllable} | Timer: {Timer} | Percent: {(double)(Percent * 100)}% | Countdown: {Countdown}";
            }
            else return $"Controllable: {Controllable} | Timer: {Timer} | Percent: {(double)(Percent * 100)}% | Countdown: {Countdown}";
        }

        public override readonly bool Equals(object obj)
        {
            return obj is TimedataDouble;
        }
        ...
        //===
        public static bool operator <(TimedataDouble timedata, double value) => timedata.Timer < value;
        public static bool operator >(TimedataDouble timedata, double value) => timedata.Timer > value;
        public static bool operator <=(TimedataDouble timedata, double value) => timedata.Timer <= value;
        public static bool operator >=(TimedataDouble timedata, double value) => timedata.Timer >= value;
        public static bool operator ==(TimedataDouble timedata, double value) => timedata.Timer == value;
        ...
        //===
        public static implicit operator TimedataDouble(double limit) => new(limit);
    }
}
